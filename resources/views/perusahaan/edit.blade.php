...
<div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
			  		...
			  		<div class="form-group {{ $errors->has('tgl_mulai') ? ' has-error' : '' }}">
			  			...
			  			<input type="date" name="tgl_mulai" value="{{ $p->tgl_mulai }}" class="form-control"  required>
                   ...
                   <div class="form-group {{ $errors->has('telepon') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="telepon" value="{{ $p->telepon }}" class="form-control"  required>
			  		...
			  		<div class="form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
			  			...
			  			<select name="user_id" value="{{ $p->user_id }}"class="form-control">
			  				@foreach($o as $data)
